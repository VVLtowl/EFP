...
void JBH_TurnStart::MainUpdate()
{
	Print("step: Turn Start");
...
void JBH_CalculateActPoint::MainUpdate()
{
...
{
	m_ActOverCount = 0;
	m_ActGroup = &(m_Judgement->m_BadActGroup);
...
{
	m_ActOverCount = 0;
	m_ActGroup = &(m_Judgement->m_GoodActGroup);
	m_ActMax = m_ActGroup->m_List.size();
...
void PlayerBehaviour::SetPlayer(Player* player)
{
	m_Player = player;
}

void PBH_ClearPoint::MainUpdate()
{
...
void PBH_UpdateState::MainUpdate()
{
