...
class PBH_ClearPoint :public PlayerBehaviour
{
private:
	void MainUpdate()override;
...
class PBH_InputHand :public PlayerBehaviour
{
private:
	void MainUpdate()override;
...
class PBH_SelectAct :public PlayerBehaviour
{
private:
...
class PBH_UpdateState :public PlayerBehaviour
{
private:
	void MainUpdate()override;
...
class PBH_OpenStatus :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };

public:
	PBH_OpenStatus() { m_ID = BHID_PLAYER_OPEN_STATUS; };
};

class PBH_Caught :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_GetTool :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_Move:public PlayerBehaviour
{
private:
	void MainUpdate()override;
...
class PBH_GiveTool :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_Catch :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_StealTool :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_UseTool :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_ThenAct :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
...
class PBH_EndAct :public PlayerBehaviour
{
private:
	void MainUpdate()override { NextState(); };
